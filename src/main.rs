            ...
            tell application "iTerm"
                ...
                tell current window
                    ...
                    tell current session
                        write text "cd \"{}\" && claude --dangerously-skip-permissions \"look in todos.md, {}, ONCE YOUR DONE, update todos.md to mark you task as done, thank you for your service, YOU STOP HERE\""
                    end tell
                end tell
            end tell
            "#,
