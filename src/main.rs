            ...
            tell application "iTerm"
                ...
                tell current window
                    ...
                    tell current session
                        write text "cd \"{}\" && claude --dangerously-skip-permissions \"look in todos.md, {}, ONCE YOUR DONE, update todos.md to mark your task as done AND ADD A COMMENT about what you did, any issues encountered, or important notes. IMPORTANT: If you encounter a file that has been modified when you try to modify it, use 'sleep 120' (wait 2 minutes) and try again. CRITICAL: If you're the LAST ONE to mark your todo as complete in the current phase, you TRANSFORM INTO THE PHASE CTO. As the CTO, you must: 1) Review all completed tasks in the phase, 2) Ensure the phase is properly coded and tested, 3) Add a comprehensive comment in the PHASE SECTION of todos.md summarizing what has been done, any issues encountered, and important notes - this phase summary will be reviewed by the FINAL CTO once ALL PHASES are marked as DONE. After completing your CTO duties, YOU STOP HERE.\""
                    end tell
                end tell
            end tell
            "#,
